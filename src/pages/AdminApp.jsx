        ...
        <Card>
          {!mfa ? (
            ...
            <>
              ...
              <button onClick={async(e)=>{ e.currentTarget.disabled=true; e.currentTarget.textContent='Sending…'; await new Promise(r=>setTimeout(r,800)); setResetSent(true); e.currentTarget.disabled=false; e.currentTarget.textContent='Send Reset Link →'; }} style={{ width:'100%', padding:'11px', background:C.purple, color:'#07070f', border:'none', borderRadius:10, fontSize:13, fontWeight:800, cursor:'pointer', fontFamily:"'Syne',sans-serif", marginBottom:12 }}>Send Reset Link →</button>
